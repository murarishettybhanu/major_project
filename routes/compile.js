...
module.exports = async (req, res) => {
    ...
    hackerEarth.compile(config)
        .then(result => {
            let a = result;
            a = JSON.parse(a);
            console.log(a.compile_status)
            res.render("compiler", { code: req.body.code, lang: req.body.lang, inputs: req.body.inputs, result: a.compile_status, post: req.body.post });
            // console.log(result)
            // console.log(beautify(a, null, 2, 100));
            //Handle Result
        })
        .catch(err => {
            // console.log(err)
